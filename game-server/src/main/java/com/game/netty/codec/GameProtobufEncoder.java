 ...
 */
public class GameProtobufEncoder extends MessageToByteEncoder<GameMessage> {
    
    private static final Logger logger = LoggerFactory.getLogger(GameProtobufEncoder.class);
