 ...
 */
public class ClientProtobufDecoder extends MessageToMessageDecoder<ByteBuf> {
    
    private static final Logger logger = LoggerFactory.getLogger(ClientProtobufDecoder.class);
